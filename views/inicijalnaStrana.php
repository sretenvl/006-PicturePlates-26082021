        ...
        <form action = "models/mail.php" method = "POST">
            <div class="row justify-content-center">
                <div class="col-md-6 col-md-offset-3">
                    <input id="email" name = "emailP" placeholder="Email" class="form-control">
                    <input id="subject" name = "subjectP" placeholder="Subject" class="form-control">
                    <textarea class="form-control" name = "bodyP" id="body" placeholder="Email Body"></textarea>
                    <button class = "dugmeAdm" type = "submit" name = "porukaPosalji">Posalji</button>
                </div>
            </div>
        </form>
    </div>
