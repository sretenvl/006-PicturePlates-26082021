<?php 
    ...
    if(isset($_POST["dodajP"])){
    	...
    	elseif($size > FILE_SIZE){
    		...
    		$cena = $_POST['cena'];
    		$opis = $_POST['opis'];
			$velicina = $_POST['velicna'];
			$marka = $_POST['marka'];

    		$upit = "UPDATE posteri SET naziv = :naziv, cena = :cena, opis = :opis, slika = :slika, manjaSlika = :manjaSlika, altSlike = :alt, velicina = :velicina, marka = :marka WHERE idP = :id";
			...
			$izmena->bindParam(":velicna", $velicna);
